...
- **Homepage:** http://localhost:8081/ebookshop/
- **Book Management:** http://localhost:8081/ebookshop/books
- **Add Book:** http://localhost:8081/ebookshop/books?action=add
- **View Books:** http://localhost:8081/ebookshop/books?action=list
